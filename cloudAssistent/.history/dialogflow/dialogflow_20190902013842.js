...
async function talkToDialogflow(projectId = 'level-oxygen-251114') {
    ...
    const request = {
        ...
        queryInput: {
            text: {
                ...
                text: 'Quero fazer o deploy da imagem nginx versão latest',
    ...
    if (result.intent) {
        ...
        controller.detectKubeAcctions(result);
    } else {
